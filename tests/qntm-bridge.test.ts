...
// Synthetic, service-disconnected invite generated by this repository's own
// bridge code. The conv_id carries the literal prefix aps-selftest- so the
// value is identifiable as test material. It has never touched a relay.
...
const EXPECTED = {
  rootKey: '2e9c044b60bb6fc2bbb325284b473d9cfdf7aa85b23bf3e1dfc03e8c59e5a28e',
  aeadKey: '7ca812987f34f80d90c66f5f04128b021e8f072ce652f0667f6d71b7f1b1b8c9',
  nonceKey: '1af40416fe54d1a8783270169dcfd8881ec046943687464efb017dbe64a851c4',
  convId: '6170732d73656c66746573742de293f1',
};
...
describe('QSP-1 v1.0-rc1 — Roundtrip Conformance Vector', () => {
  // Fixed test vector from spec. seed, publicKey, sender, msgId and plaintext
  // are spec inputs and are unchanged. nonce, aadHash, ciphertext and sig are
  // derived from the invite above, so they are regenerated whenever it changes.
  const VECTOR = {
    ...
    nonce: '8baebf8e4cb414ff648508b065883e5d2bf258fd7f81f17c',
    ciphertext: 'f8f49682ec15ddf6efea9f726c6df93ef9c7a88ff69dd2bdf945ddd6a880fc3d5c3e79e190cf873f18f89bec',
    aadHash: '014d5971cabb378b54c61e11df50048242481cd8c25b712f0aa22981b1e468ef',
    sig: 'ac4d07ad8721b7fe860504a8c66b0bbc32fa78e0a42a9f1ad4b28366da45d998ef861f10e058036920734726b265226c6b90ec2ca3e92837d9d7181864926b0d',
  };
