...
The full suite (`npm test`) must pass before submitting a PR; the current totals are whatever it reports, not a number written here. TypeScript strict mode must compile clean.
